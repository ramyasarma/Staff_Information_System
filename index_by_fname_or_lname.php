...
<div id="wrapper">
	...
	<body>
	 <p style='color:white;'>Display the employee details by entering the first name or the last name </p>
	 <p style='color:white;'>Enter the characters in first or last name </p>
