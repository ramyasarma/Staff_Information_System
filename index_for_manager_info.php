...
<div id="wrapper">
	...
	<body>
    <p style='color:white;'>Display the employees working under the given manager </p>
    <p style='color:white;'>Enter the manager id </p>
    
   <form action="search_for_manager_info.php" method="GET">
