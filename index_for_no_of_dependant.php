...
<body>
    <p style='color:white;'>Display the details of employees with dependants greater than n </p>
   <p style='color:white;'>Enter the value of n :</p> 
    <form action="search_by_no_of_dependant.php" method="GET">
