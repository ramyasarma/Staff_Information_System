...
<div id="wrapper">
	...
	<body>
   <p style='color:white;'>Display the project details with the given project id </p>
    <p style='color:white;'>Enter the project id </p>
    
   <form action="search_for_project_list.php" method="GET">
