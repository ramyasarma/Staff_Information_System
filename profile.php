...
<div id="wrapper">
	...
	<div id="two-columns">
		<div id="col1">
			<h2 align="center" >Welcome to Staff Information System</h2> 
			
			
			
			<p align="center" style="color:white"> Click here to <a style="color:white" href="change_password.php">Change Password</a> </p>
			<p align="center" style="color:white"> Click here to <a style="color:white" href="logout.php">LogOut</a> </p>
