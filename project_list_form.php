...
echo "<table border='1'>
<tr>
<th><p style='color:white;'>Project Id</p></th>
<th><p style='color:white;'>Client</p></th>
<th><p style='color:white;'>Project name</p></th>
<th><p style='color:white;'>Start date</p></th>
<th><p style='color:white;'>end date</p></th>
<th><p style='color:white;'>Project leader Id</p></th>
<th><p style='color:white;'>Team leader Id</p></th>
<th><p style='color:white;'>Budget</p></th>
</tr>";

while($row = mysqli_fetch_array($result))
  {
  echo "<tr>";
  echo "<td><p style='color:white;'>" . $row['project_id'] . "</p></td>";
  echo "<td><p style='color:white;'>" . $row['client'] . "</p></td>";
  echo "<td><p style='color:white;'>" . $row['project_name'] . "</p></td>";
  echo "<td><p style='color:white;'>" . $row['start_date'] . "</p></td>";
  echo "<td><p style='color:white;'>" . $row['end_date'] . "</p></td>";
  echo "<td><p style='color:white;'>" . $row['project_leader_id'] . "</p></td>";
  echo "<td><p style='color:white;'>" . $row['team_leader_id'] . "</p></td>";
  echo "<td><p style='color:white;'>" . $row['budget'] . "</p></td>";
