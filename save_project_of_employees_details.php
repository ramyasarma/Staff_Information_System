...
<div id="wrapper">
    ...
    $sql = "INSERT INTO project_of_employees 
                          
            	VALUES ('$employee_id','$project_id','$project_name')";           			
...
$result = mysqli_query($con,"SELECT * FROM project_of_employees where employee_id=$employee_id");
