...
<div id="wrapper">
    ...
    $sql = "UPDATE time_info SET 
                	worked_hours=worked_hours+$worked_hours,
            		overtime_worked_hours=overtime_worked_hours+$overtime_worked_hours, 
			sick_leaves=sick_leaves + $sick_leaves,
	paid_leaves= paid_leaves + $paid_leaves
...
<th><p style='color:white;'>Worked hours</p></th>
<th><p style='color:white;'>OverTime Worked Hours</p></th>
<th><p style='color:white;'>Sick Leaves</p></th>
<th><p style='color:white;'>Paid Leaves</p></th>
</tr>";
...
while($row = mysqli_fetch_array($result))
  ...
  echo "<td><p style='color:white;'>" . $row['worked_hours'] . "</p></td>";
  echo "<td><p style='color:white;'>" . $row['overtime_worked_hours'] . "</p></td>";
  echo "<td><p style='color:white;'>" . $row['sick_leaves'] . "</p></td>";
  echo "<td><p style='color:white;'>" . $row['paid_leaves'] . "</p></td>";
  echo "</tr>";
  }
echo "</table>";
