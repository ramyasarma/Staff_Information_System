...
$result = mysqli_query($con,"SELECT * FROM work_experience where employee_id=$employee_id");

echo "<table border='1'>
<tr>
<th><p style='color:white;'>Employee Id</p></th>
<th><p style='color:white;'>Name Of Company</p></th>
<th><p style='color:white;'>Date of Joining</p></th>
<th><p style='color:white;'>Date of Leaving</p></th>
<th><p style='color:white;'>Position Held</p></th>
</tr>";
